<template>
    <div
        class="inset-x-0 -z-10 bg-gradient shadow-lg ring-1 ring-gray-900/5 min-h-screen"
    >
        <!--
         ...
         -->
        <div
            id="actual-size-of-navigation-window"
                ...
                <div>
                    ...
                    <div class="mt-6 flow-root">
                        <div class="-my-2">
                            ...
                            >
                                <img
                                    class="w-4 h-4 group-hover:w-5 group-hover:h-5 transition-all rounded-full object-cover shadow-md"
                                    alt="Logo"
                                    :src="item.icon"
                                />
                                {{ item.name }}
...
export default {
    ...
    methods: {
        openNavigation() {
            ...
            const navigationWindow = document.getElementById(
                "actual-size-of-navigation-window"
            );
            if (content && navigationWindow) {
                content.style.transform = `translateY(${
                    navigationWindow.getBoundingClientRect().height
                }px)`;
            }
        },
