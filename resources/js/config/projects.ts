const projects = [
    ...
    },
    {
        ...
        description:
            "Syntak designed this beautiful app for the real estate agents at Homexe to help them track their sales progress. The app seamlessly integrated with their CRM, Follow Up Boss, to much of the automate data transfer.",
    },
];
