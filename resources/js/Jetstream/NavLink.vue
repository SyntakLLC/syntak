<script setup>
    ...
    const classes = computed(() => {
        return props.active
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-brand-400 text-sm font-medium leading-5 text-gray-900 focus:outline-none focus:border-brand-700 transition'
